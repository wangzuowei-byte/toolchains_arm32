...
TOOLCHAINS_TAR=gcc-arm-10.3-2021.07-x86_64-arm-none-linux-gnueabihf.tar.xz
TOOLCHAINS_INSATLL_DIR=gcc-arm-10.3-2021.07-x86_64-arm-none-linux-gnueabihf
TOOLCHAINS_BASH_PATH=armhf_none_10.3_2021.07
...
function install_armcc()
{
    ...
    cp -a ${workspace_path}/sdk_path/* ${toolchains_path}/arm-none-linux-gnueabihf/libc/
    ...
    link_stm_tools ${TOOLCHAINS_BIN_NAME} ${TOOLCHAINS_STM_SRC_NAME} ${toolchains_path}
